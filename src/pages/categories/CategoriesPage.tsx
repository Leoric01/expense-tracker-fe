...
export const CategoriesPage: FC = () => {
  ...
  const trackerName = selectedExpenseTracker?.name ?? '';
  ...
  return <CategoriesForTracker trackerId={trackerId} trackerName={trackerName} />;
};

const CategoriesForTracker: FC<{ trackerId: string; trackerName: string }> = ({
  trackerId,
  trackerName,
}) => {
